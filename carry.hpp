...
namespace fcl {
    ...
    auto carry(Ret (*fn)(Args...), Some &&...arg)
        -> decltype(details::carry_(fn, details::make_int_sequence<sizeof...(Args) - sizeof...(Some)>{}, std::forward<Some>(arg)...)) {
        return details::carry_(fn, details::make_int_sequence<sizeof...(Args) - sizeof...(Some)>{}, std::forward<Some>(arg)...);
    }
    ...
    auto carry(Ret (T::*fn)(Args...), Some &&...arg)
        -> decltype(details::carry_(fn, details::make_int_sequence<sizeof...(Args) - sizeof...(Some) + 1>{}, std::forward<Some>(arg)...)) {
        return details::carry_(fn, details::make_int_sequence<sizeof...(Args) - sizeof...(Some) + 1>{}, std::forward<Some>(arg)...);
    }
    ...
    auto carry(Fn f, Some &&...arg)
        -> decltype(carry(details::FFL(f), arg...)) {
        return carry(details::FFL(f), arg...);
    }
}
